...
**It suggests. It does not decide, and it does not trade.** The user
checks each line against their own charts and tells it what they did.
"""
import datetime
...
def format_review(result):
    ...
    lines.append("any of it, then record what was actually done. A declined")
    lines.append("candidate is as useful to the record as one taken.")
    return "\n".join(lines)
