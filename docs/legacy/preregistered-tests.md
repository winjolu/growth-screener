...
relative to owning the index, and the low drawdown is what comes of
...
measured defect. This is **mined from the data**, at my own
direction, after he correctly pointed out that my original objection —
...
the project instructions. The pattern is consistent enough to be worth stating as a
...
My stated product needs "what share of the stake goes into each",
...
Not a registered test. I asked which ratio was being used and the
answer was none: raw return beside raw drawdown, with one ad-hoc
...
buyouts**, which made survivorship look worse than it is. Found because
I asked what happens to shares in an acquisition.
